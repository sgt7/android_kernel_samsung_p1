/* linux/arch/arm/mach-s5pv210/mach-crespo.c
 *
...
static struct regulator_init_data crespo_buck4_data = {
	.constraints	= {
...
static struct max8998_regulator_data crespo_regulators[] = {
	...
	{ MAX8998_BUCK4, &crespo_buck4_data },
};
...
static struct max8998_charger_data crespo_charger = {
...
static struct gpio_event_direct_entry crespo_keypad_key_map[] = {
	{
		.gpio	= S5PV210_GPH2(6),
		.code	= KEY_POWER,
	},
...
static struct gpio_event_input_info crespo_keypad_key_info = {
	.info.func = gpio_event_input_func,
	.info.no_suspend = true,
	.debounce_time.tv.nsec = 5 * NSEC_PER_MSEC,
	.type = EV_KEY,
	.keymap = crespo_keypad_key_map,
	.keymap_size = ARRAY_SIZE(crespo_keypad_key_map)
};

static struct gpio_event_info *crespo_input_info[] = {
	&crespo_keypad_key_info.info,
};


static struct gpio_event_platform_data crespo_input_data = {
	.names = {
		"crespo-keypad",
		NULL,
	},
	.info = crespo_input_info,
	.info_count = ARRAY_SIZE(crespo_input_info),
};

static struct platform_device crespo_input_device = {
	.name = GPIO_EVENT_DEV_NAME,
	.id = 0,
	.dev = {
		.platform_data = &crespo_input_data,
	},
};
...
static void crespo_power_off(void)
{
	while (1) {
...
static void __init crespo_map_io(void)
{
...
static void __init crespo_fixup(struct machine_desc *desc,
...
static void __init crespo_machine_init(void)
{
...
MACHINE_START(SMDKC110, "SMDKC110")
	...
	.map_io		= crespo_map_io,
	.init_machine	= crespo_machine_init,
